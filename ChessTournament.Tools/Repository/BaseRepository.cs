using ChessTournament.DAL;
using ChessTournament.Tools.Interfaces;
using System;
...
namespace ChessTournament.Tools.Repository
{
    internal class BaseRepository<T, TEntity> : IRepository<T, TEntity> where TEntity : class, IEntity<T>
    {
